...
(function() {
 ...
 loadPackage({
  ...
  "package_uuid": "a2fd4322-6506-4148-a334-532704aba047"
 });
})();
...
assert(INITIAL_MEMORY == 524288e3, "Detected runtime INITIAL_MEMORY setting.  Use -s IMPORTED_MEMORY to define wasmMemory dynamically");
...
var _trackInfo = Module["_trackInfo"] = createExportWrapper("trackInfo");
