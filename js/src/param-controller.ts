...
export class ParamController {
  ...
  constructor(parentId, onChangeCallback, options) {
    ...
    this.controller_.max = typeof options.max === "undefined" ? 1 : options.max;
    this.controller_.step = typeof options.step === "undefined" ? 0.1 : options.step;
    ...
    if (this.controller_.type === "range") this.controller_.className += "slider";
    else throw this.controller_.type + " not defined.";
