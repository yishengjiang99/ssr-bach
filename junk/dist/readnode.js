...
function UTF16ToString(ptr, maxBytesToRead) {
    ...
    while (!(idx >= maxIdx) && _asan_js_load_2u(idx))
        ++idx;
    endPtr = idx << 1;
...
var STACK_BASE = 49186176, STACKTOP = STACK_BASE, STACK_MAX = 43943296;
assert(STACK_BASE % 16 === 0, "stack must start aligned");
var TOTAL_STACK = 5242880;
if (Module["TOTAL_STACK"])
    assert(TOTAL_STACK === Module["TOTAL_STACK"], "the stack size can no longer be determined at runtime");
var INITIAL_INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 314572800;
...
var wasmSourceMapFile = "readnode.wasm.map";
if (!isDataURI(wasmBinaryFile)) {
...
var ___heap_base = Module["___heap_base"] = 49186176;
var ___global_base = Module["___global_base"] = 39321600;
