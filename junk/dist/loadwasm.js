...
exports.loadReader = void 0;
const fs = require("fs");
const flsf = fs.readFileSync("./file.sf2");
const ab = new Uint8Array(fs.readFileSync("./readnode.wasm"));
async function loadReader() {
    ...
    //@ts-ignore
    debugger;
    //  instance.exports.tsf(sfptr, flsf.byteLength);
    let wptr = 0;
    return {
        sample: (preset, midi, velocity, seconds) => {
            const n = seconds * 31000;
            //@ts-ignore
            const ptr = instance.exports.ssample(preset, midi, velocity, n);
            const cp = Buffer.from(memory.buffer.slice(ptr, ptr + n * Float32Array.BYTES_PER_ELEMENT));
            //@ts-ignore
